...
namespace IslandGame.GameWorld
{
    ...
    class DayNightCycler
    {
        ...
        public DayNightCycler()
        {
            ...
            TimeOfDay broadDay = new TimeOfDay(new Vector4(.392f, .584f, .733f, 1), new Vector4(.019f, .243f, .549f, 1) * 1.7f, .9f, 10000, false);//DAY SET SUPER LONG
            TimeOfDay evening = new TimeOfDay(new Vector4(.694f, .416f, .306f, 1), new Vector4(.0588f, .2706f, .512f, 1), .4f, 2, false);
            TimeOfDay night = new TimeOfDay(new Vector4(0, 0, 0, 1), new Vector4(0, 0, 0, 1), .2f, 8, true);
